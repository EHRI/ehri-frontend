...
object ApplicationBuild extends Build {
  ...
  val backendDependencies = Seq(
    ...
    // Ontology
    "ehri-project" % "ehri-definitions" % "0.9.2-SNAPSHOT",
  ...
  val backendTestDependencies = Seq(
    ...
    "ehri-project" % "ehri-frames" % "0.9.2-SNAPSHOT" % "test" classifier "tests" classifier "" exclude("com.tinkerpop.gremlin", "gremlin-groovy"),
    "ehri-project" % "ehri-extension" % "0.9.2-SNAPSHOT" % "test" classifier "tests" classifier "" exclude("com.tinkerpop.gremlin", "gremlin-groovy")
  )
