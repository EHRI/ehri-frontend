...
trait CRUD[F <: Persistable, T <: AccessibleEntity with Formable[F]] extends EntityCreate[F,T] with EntityRead[T] with EntityUpdate[F,T] with EntityDelete[F,T]
...
trait EntityDelete[F <: Persistable, T <: AccessibleEntity] extends EntityRead[T] {
