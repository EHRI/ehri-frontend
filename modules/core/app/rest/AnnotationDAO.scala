...
case class AnnotationDAO() extends RestDAO {
  ...
  def getFor(id: String)(implicit apiUser: ApiUser): Future[Map[String,List[Annotation]]] = {
  ...
  def create(id: String, ann: AnnotationF)(implicit apiUser: ApiUser): Future[Annotation] = {
