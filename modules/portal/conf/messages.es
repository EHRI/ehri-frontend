...
facet.creation=Fuente de la descripción
facet.creation.tooltip=La fuente de la descripción digital, p. ej., si ha sido creada por el personal del EHRI o importada a partir de los datos estructurados cedidos por una institución asociada.
facet.creation.MANUAL=EHRI
facet.creation.IMPORT=Institución asociada al EHRI
