...
trait FileStorage {
   ...
   */
  def putFile(instance: String, classifier: String, path: String, file: File)(implicit executionContext: ExecutionContext): Future[URI]
  ...
  /**
    ...
    * @param path        additional file path, including the file name with extension
    */
  def delete(instance: String, classifier: String, path: String)(implicit executionContext: ExecutionContext): Future[Unit]
}
