...
class FieldMetadataSetSpec extends PlaySpecification {
  ...
  private val fm1 = FieldMetadata(et, "1", "test1", Some("description"), Option.empty[FieldMetadata.Usage.Value], Some("info"), Seq("seeAlso"))
  private val fm2 = FieldMetadata(et, "2", "test2", Some("description"), Option.empty[FieldMetadata.Usage.Value], None, Seq("seeAlso"))
