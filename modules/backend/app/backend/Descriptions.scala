...
trait Descriptions {
  ...
  def createAccessPoint[MT, DT](id: String, did: String, item: DT, logMsg: Option[String] = None)(implicit apiUser: ApiUser, rs: BackendResource[MT], fmt: BackendWriteable[DT], executionContext: ExecutionContext): Future[DT]
