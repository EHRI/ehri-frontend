...
trait RestLinks extends Links with RestDAO with RestContext {
   ...
   */
  override def linkItems[MT, A <: WithId, AF](id: String, src: String, link: AF, accessPoint: Option[String] = None)(implicit rs: Resource[MT], rd: BackendReadable[A], wd: BackendWriteable[AF]): Future[A] = {
   ...
   */
  override def linkMultiple[MT, A <: WithId, AF](id: String, srcToLinks: Seq[(String,AF,Option[String])])(implicit rs: Resource[MT], rd: BackendReadable[A], wd: BackendWriteable[AF]): Future[Seq[A]] = {
